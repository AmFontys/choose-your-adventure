package nl.chooseyouradventure.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(nl.chooseyouradventure.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(nl.chooseyouradventure.configuration.security.isauthenticated.IsAuthenticated)")
